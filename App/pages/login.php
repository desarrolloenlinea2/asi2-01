            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form form method="POST" action="../php/getin.php" role="form">
                            <fieldset>
                            ...
                            <!--
                                <div class="form-group">
                                    ...
                                    <select name="Empresas" class="form-control">-->
                                        ...
                                        //    $get_user = mysql_query("SELECT IdEmp, NComer FROM Empresa ORDER BY NComer ASC ");
                            ...
                            -->
                                ...
                                <button type="submit" class="btn btn-lg btn-success btn-block" value="">Login</button>
                                <!--<a href="index.html" class="btn btn-lg btn-success btn-block">Login</a>-->
                            </fieldset>
                        </form>
                    </div>
                    <div class="panel-footer">
                        <a href="loginclient.php"><i class="fa fa-user fa-fw"></i>Ingresar como Cliente</a>
                    </div>
                </div>
            </div>
        </div>
