                                ...
                                <div class="col-lg-6">
                                    ...
                                    ?>
                                        <form form method="POST" action="<?php print $_SERVER['PHP_SELF']; ?>" role="form">
                                            ...
                                            <?php print'<input type="hidden" name="caso" value="'.$id.'">'?>
                                        </form>
                                    <?php 
                                    } 
                                    ...
                                    function process_form( ) { 
                                        ...
                                        $Id = mysqli_real_escape_string($con,$_POST['caso']);
                                        $usuario = mysqli_real_escape_string($con,$_POST['Usuario']);
                                        $Descrip = mysqli_real_escape_string($con,$_POST['Descrip']);
                                        $Estado = mysqli_real_escape_string($con,'Finalizado');
                                        $coment = 'Caso Finalizado';
                                        $q = "UPDATE Tikets SET FFinal=Now(),IdEstado='$Estado',Solucion='$Descrip',Acepta='$usuario' WHERE IdTiket='$Id'";              
